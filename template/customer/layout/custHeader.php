  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/decor/template/customer/dashboard/homeDecor.php">Home decor</a>
        </li>
        <li class="nav-item">
      ...
      <form class="d-flex">
        <button type="button" class="btn btn-light" style=" position: relative ;left:-20px"><a href=""><svg style="color:green;" xmlns="http://www.w3.org/2000/svg"  width="16" height="16" fill="currentColor" class="bi bi-cart-fill" viewBox="0 0 16 16">
